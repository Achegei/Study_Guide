    ...
    <section class="bg-gray-50 py-12 sm:py-20">
        <div class="max-w-4xl mx-auto px-4">
                        ...
                        <div class="bg-white p-6 sm:p-8 rounded-2xl shadow-lg border border-gray-100">
                            <div class="flex items-start gap-4 sm:gap-6">
                                ...
                                <div class="flex-1">
                                    ...
                                    <p class="text-gray-700 mt-2 whitespace-pre-line leading-relaxed">{{ $testimonial->content }}</p>
                                </div>
                            </div>
                        </div>
                    @endforeach
            ...
            <div class="mt-16 max-w-2xl mx-auto">
                ...
                <form action="{{ route('testimonials.store') }}" method="POST" class="bg-white p-8 rounded-2xl shadow-2xl space-y-6 border border-gray-100">
                    @csrf
                    <div>
