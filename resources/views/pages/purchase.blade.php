...
@section('content')
    ...
    <section class="py-20 md:py-24 text-center bg-white rounded-b-3xl shadow-lg">
        <div class="max-w-4xl mx-auto px-4">
            ...
            <div class="mt-8">
                <a href="{{ route('canadian-citizenship-prep') }}" class="inline-block bg-blue-700 hover:bg-blue-600 text-white px-8 py-4 rounded-full font-semibold shadow-lg transition-all duration-300 transform hover:scale-105">
                    Start Your Prep Now
                </a>
            </div>
        </div>
