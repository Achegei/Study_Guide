        ...
        <div class="max-w-7xl mx-auto px-6">
            <div class="bg-white rounded-3xl shadow-xl p-8 lg:p-10 border border-gray-200">
                <h1 class="text-4xl font-extrabold text-gray-900 mb-8 text-center">
                    Comprehensive Driving Guide: British Columbia
                </h1>

                <div class="prose max-w-none text-gray-800 leading-relaxed">
                    <p class="mb-6 text-center">Understanding road signs is crucial for safe driving in British Columbia. These signs provide vital information about regulations, warnings, and guidance. Here's a look at some key road signs you'll encounter and their meanings.</p>
                    ...
                    <div class="prose-grid"> {{-- This div will become a two-column grid on medium screens and up --}}
                        ...
                        {{-- Sign 1 --}}
                        <div class="sign-item">
                            <img src="{{ asset('images/driving-signs/alberta/1.jpeg') }}" alt="Two Way Traffic Sign">
                            <div>
                        ...
                        {{-- Sign 2 --}}
                        <div class="sign-item">
                            <img src="{{ asset('images/driving-signs/alberta/2.jpeg') }}" alt="Driver Ahead, Keep Right Sign">
                            <div>
                        ...
                        {{-- Sign 3 --}}
                        <div class="sign-item">
                            <img src="{{ asset('images/driving-signs/alberta/3.jpeg') }}" alt="Road Narrows on Both Sides Sign">
                            <div>
                        ...
                        {{-- Sign 4 --}}
                        <div class="sign-item">
                            <img src="{{ asset('images/driving-signs/alberta/4.jpeg') }}" alt="Do Not Enter Sign">
                            <div>
                                <h3>Do Not Enter</h3>
                        ...
                        {{-- Sign 5 --}}
                        <div class="sign-item">
                            <img src="{{ asset('images/driving-signs/alberta/5.jpeg') }}" alt="No Left Turn Sign">
                            <div>
                        ...
                        {{-- Sign 6 --}}
                        <div class="sign-item">
                            <img src="{{ asset('images/driving-signs/alberta/6.jpeg') }}" alt="No Stopping in Indicated Area Sign">
                            <div>
                        ...
                        {{-- Sign 7 --}}
                        <div class="sign-item">
                            <img src="{{ asset('images/driving-signs/alberta/7.jpeg') }}" alt="School Bus Stop Ahead Sign">
                            <div>
                        ...
                        {{-- Sign 8 --}}
                        <div class="sign-item">
                            <img src="{{ asset('images/driving-signs/alberta/8.jpeg') }}" alt="Uneven Pavement Sign">
                            <div>
                        ...
                        {{-- Sign 9 --}}
                        <div class="sign-item">
                            <img src="{{ asset('images/driving-signs/alberta/9.jpeg') }}" alt="Dead End Sign">
                            <div>
                                <h3>Dead End</h3>
                        ...
                        {{-- Sign 10 --}}
                        <div class="sign-item">
                            <img src="{{ asset('images/driving-signs/alberta/10.jpeg') }}" alt="Bump or Uneven Pavement Sign">
                            <div>
                        ...
                        {{-- Sign 11 --}}
                        <div class="sign-item">
                            <img src="{{ asset('images/driving-signs/alberta/11.jpeg') }}" alt="Playground Zone Sign">
                            <div>
                        ...
                        {{-- Sign 12 --}}
                        <div class="sign-item">
                            <img src="{{ asset('images/driving-signs/alberta/12.jpeg') }}" alt="Winding Road Ahead Sign">
                            <div>
                        ...
                        {{-- Sign 13 --}}
                        <div class="sign-item">
                            <img src="{{ asset('images/driving-signs/alberta/13.jpeg') }}" alt="Yield the Right of Way Sign">
                            <div>
                        ...
                        {{-- Sign 14 --}}
                        <div class="sign-item">
                            <img src="{{ asset('images/driving-signs/alberta/14.jpeg') }}" alt="Roundabout Sign">
                            <div>
                                <h3>Roundabout</h3>
                        ...
                        {{-- Sign 15 --}}
                        <div class="sign-item">
                            <img src="{{ asset('images/driving-signs/alberta/15.jpeg') }}" alt="Share the Road Sign">
                            <div>
                        ...
                        {{-- Sign 16 --}}
                        <div class="sign-item">
                            <img src="{{ asset('images/driving-signs/alberta/16.jpeg') }}" alt="School Crosswalk Sign">
                            <div>
                        ...
                        {{-- Sign 17 --}}
                        <div class="sign-item">
                            <img src="{{ asset('images/driving-signs/alberta/17.jpeg') }}" alt="Dangerous Goods Sign">
                            <div>
                        ...
                        {{-- Sign 18 --}}
                        <div class="sign-item">
                            <img src="{{ asset('images/driving-signs/alberta/18.jpeg') }}" alt="Right Lane Ends Sign">
                            <div>
                        ...
                        {{-- Sign 19 --}}
                        <div class="sign-item">
                            <img src="{{ asset('images/driving-signs/alberta/19.jpeg') }}" alt="Slow Moving Vehicle Sign">
                            <div>
                        ...
                        {{-- Sign 20 --}}
                        <div class="sign-item">
                            <img src="{{ asset('images/driving-signs/alberta/20.jpeg') }}" alt="Turn Right Only Sign">
                            <div>
