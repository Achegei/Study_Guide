{{-- resources/views/auth/practice-test.blade.php --}}
    ...
    <section class="bg-gray-50 py-12 sm:py-20">
        <div class="max-w-6xl mx-auto px-4">
            ...
            <div class="mt-16 text-center">
                ...
                <a href="{{route('purchase')}}" class="mt-4 inline-block text-blue-600 hover:text-blue-800 font-semibold underline text-lg transition-colors duration-200">
