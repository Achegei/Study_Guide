<?php $__env->startSection('content'); ?>
    <div class="max-w-4xl mx-auto px-4 py-12">
        ...
        <?php echo e(__('Course Payment & Access Request')); ?>

        </h1>
        <div class="mb-8 text-gray-600 text-center max-w-2xl mx-auto">
        <p class="font-semibold mb-2 text-lg text-gray-700"><?php echo e(__('Before Completing the Form:')); ?></p>
            <ul class="list-disc list-inside space-y-1 mb-4 text-left mx-auto max-w-xs">
                <li><?php echo e(__('Send your Interac e-Transfer to: payment@iqracanadatestprep.ca')); ?></li>
                <li><?php echo e(__('Set the Security Answer as: IQRA (ALL CAPITAL LETTERS)')); ?></li>
            </ul>

    <p class="font-semibold mb-2 text-lg text-gray-700"><?php echo e(__('After Payment Confirmation:')); ?></p>
    <ul class="list-disc list-inside space-y-1 mb-4 text-left mx-auto max-w-xs">
        <li><?php echo e(__('Username: Your email used to send the e-Transfer')); ?></li>
        <li><?php echo e(__('Password: A temporary password will be sent to your email (you can change it later)')); ?></li>
    </ul>

    <p class="text-lg font-bold text-gray-800"><?php echo e(__('✅ Finally, enjoy one full year of access to the platform!')); ?></p>
</div>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="flex items-start">
                ...
                <label for="payment_confirmation" class="text-sm text-gray-700">
                    I confirm I have sent payment via Interac e-Transfer to: <strong class="text-blue-600">payment@iqracanadatestprep.ca</strong>
                </label>
            </div>
