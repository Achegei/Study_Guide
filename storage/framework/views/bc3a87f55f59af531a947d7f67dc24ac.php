    ...
    <section class="py-12 sm:py-20">
        <div class="max-w-6xl mx-auto px-4">
            ...
            <div class="mt-16 text-center bg-blue-700 p-8 rounded-3xl shadow-xl border border-blue-800">
                ...
                <a href="<?php echo e(route('free-quiz.show')); ?>" class="inline-block bg-white hover:bg-gray-200 text-blue-700 px-8 py-4 rounded-full font-semibold shadow-lg transition-all duration-300 transform hover:scale-105">
                    Start Free Test Now
                </a>
            </div>
        </div>
