    ...
    <div class="w-full sm:max-w-md mt-6 px-6 py-4 bg-white shadow-md overflow-hidden sm:rounded-lg">
        <div class="flex justify-center mb-4">
            ...
            <a href="/">
                ...
                <h2 class="text-2xl font-bold text-red-600 text-center mt-2">Canadian Citizenship Prep</h2>
            </a>
        </div>
...
<?php echo $__env->make('layouts.guest', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mohamudhassanmayow/Desktop/Study_Guide/resources/views/auth/login.blade.php ENDPATH**/ ?>