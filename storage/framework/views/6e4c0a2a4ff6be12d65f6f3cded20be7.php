...
<section class="bg-white py-20">
    <div class="max-w-7xl mx-auto px-4 flex flex-col lg:flex-row items-center gap-12">
        <div class="lg:w-1/2" data-aos="fade-right">
            <img src="<?php echo e(asset('images/canadian-flag.png')); ?>" alt="Studying" class="rounded-xl shadow-xl w-full h-auto">
        </div>
...
<section class="bg-red-50 py-20">
    <div class="max-w-7xl mx-auto px-4 grid md:grid-cols-2 gap-10 items-center">
        ...
        <div class="flex justify-center" data-aos="zoom-in">
            <img src="<?php echo e(asset('images/road-signs.png')); ?>" alt="Canadian Flag" class="w-44 h-auto">
        </div>
    </div>
</section>
...
<section class="bg-blue-50 py-20">
    <div class="max-w-7xl mx-auto px-4 grid md:grid-cols-2 gap-10 items-center">
        <div class="flex justify-center" data-aos="zoom-in">
            <img src="<?php echo e(asset('images/ottawa.png')); ?>" alt="Proudly Canadian" class="w-44 h-auto">
        </div>
...
<?php echo $__env->make('layouts.guest', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mohamudhassanmayow/Desktop/Study_Guide/resources/views/pages/about.blade.php ENDPATH**/ ?>