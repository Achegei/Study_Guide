    ...
    <div class="w-full sm:max-w-md mt-6 px-6 py-4 bg-white shadow-md overflow-hidden sm:rounded-lg">
        <div class="flex justify-center mb-4">
            <a href="/">
                ...
                <h2 class="text-2xl font-bold text-navy-blue text-center mt-2">IQRA Canada Test Prep</h2>
            </a>
        </div>
        ...
        <form method="POST" action="<?php echo e(route('password.email')); ?>">
            ...
            <div class="mt-4">
                ...
                <input id="email" class="block mt-1 w-full border-gray-300 rounded-md shadow-sm focus:border-red-500 focus:ring-red-500" type="email" name="email" value="<?php echo e(old('email')); ?>" required autofocus />
...
<?php echo $__env->make('layouts.guest', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mohamudhassanmayow/Desktop/Study_Guide/resources/views/auth/forgot-password.blade.php ENDPATH**/ ?>