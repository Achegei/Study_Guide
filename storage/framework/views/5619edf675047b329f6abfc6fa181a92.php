            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                <div class="bg-gray-100 p-6 rounded-xl shadow-lg">
                    ...
                    <div class="flex items-center">
                        <img src="<?php echo e(asset('images/person1.jpg')); ?>" alt="User 1" class="w-12 h-12 rounded-full mr-4 object-cover">
                ...
                <div class="bg-gray-100 p-6 rounded-xl shadow-lg">
                    ...
                    <div class="flex items-center">
                        <img src="<?php echo e(asset('images/person2.jpg')); ?>" alt="User 2" class="w-12 h-12 rounded-full mr-4 object-cover">
                ...
                <div class="bg-gray-100 p-6 rounded-xl shadow-lg">
                    ...
                    <div class="flex items-center">
                        <img src="<?php echo e(asset('images/person3.jpg')); ?>" alt="User 3" class="w-12 h-12 rounded-full mr-4 object-cover">
    ...
    <section class="py-16 bg-gray-50">
        <div class="max-w-4xl mx-auto px-4 text-center">
            ...
            <div class="mt-8 flex flex-wrap justify-center gap-8">
                ...
                <a href="<?php echo e(route('free-quiz.show')); ?>" class="inline-block bg-blue-700 hover:bg-blue-600 text-white px-8 py-4 rounded-full font-semibold shadow-lg transition-all duration-300 transform hover:scale-105">
                    <?php echo e(__('Start With Free Test')); ?>
