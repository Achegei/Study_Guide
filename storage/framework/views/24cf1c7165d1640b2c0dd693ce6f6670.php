    ...
    <section class="relative text-white py-20 md:py-32 rounded-b-3xl shadow-xl overflow-hidden">
        ...
        <div class="relative z-10 max-w-7xl mx-auto px-6 text-center">
            ...
            <div class="flex flex-col sm:flex-row justify-center items-center gap-4">
                <a href="<?php echo e(route('register.payment')); ?>" class="inline-block bg-white text-blue-800 font-bold px-8 py-4 rounded-full shadow-lg hover:bg-gray-100 transform hover:scale-105 transition-all duration-300">
                    Get Started for $10
                </a>
        ...
        <div class="max-w-4xl mx-auto px-4">
            ...
            <div class="bg-blue-800 text-white rounded-xl shadow-lg p-8 text-center mt-12">
                ...
                <div class="flex justify-center mb-4">
                    <img src="<?php echo e(asset('images/interac-logo.png')); ?>" onerror="this.onerror=null;this.src='https://placehold.co/200x50/FFFFFF/000000?text=Interac+e-Transfer';" alt="Interac e-Transfer" class="h-10 w-auto">
                </div>
