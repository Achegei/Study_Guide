...
<head>
    ...
    <title><?php echo e($title ?? 'Road to Citizenship Canada'); ?></title>
...
<body class="bg-gray-50 text-gray-800">
    ...
    <header class="bg-white shadow-sm">
        <div class="max-w-7xl mx-auto px-4 py-4 flex flex-col md:flex-row justify-between items-center gap-2 md:gap-0">
            ...
            <a href="<?php echo e(route('interac.purchase.submit')); ?>">
    ...
    <nav class="bg-red-600 text-white sticky top-0 z-50" x-data="{ open: false }">
        <div class="max-w-7xl mx-auto px-4 py-3 flex justify-between items-center">
            <ul class="hidden md:flex gap-6 font-semibold">
                ...
                <li><a href="<?php echo e(route('purchase')); ?>" class="hover:underline">Get Access</a></li>
                <li><a href="<?php echo e(route('testimonials')); ?>" class="hover:underline">Learner Feedback</a></li>
                <li><a href="<?php echo e(route('free-test')); ?>" class="hover:underline">Free Practice Tests</a></li>
                <li><a href="<?php echo e(route('blogs.index')); ?>" class="hover:underline">Learn About Citizenship</a></li>
                <li><a href="<?php echo e(route('tips')); ?>" class="hover:underline">Study Tips</a></li>
        ...
        <div x-show="open" x-transition class="md:hidden px-4 pb-4">
            <ul class="space-y-2">
                ...
                <li><a href="<?php echo e(route('purchase')); ?>" class="block py-1">Get Access</a></li>
                <li><a href="<?php echo e(route('testimonials')); ?>" class="block py-1">Learner Feedback</a></li>
                <li><a href="<?php echo e(route('free-test')); ?>" class="block py-1">Free Practice Tests</a></li>
                <li><a href="<?php echo e(route('blogs.index')); ?>" class="block py-1">Learn About Citizenship</a></li>
                <li><a href="<?php echo e(route('tips')); ?>" class="block py-1">Study Tips</a></li>
                <li><a href="<?php echo e(route('about')); ?>" class="block py-1">About Us</a></li>
            </ul>
        </div>
    </nav>
    ...
    <footer class="bg-gray-900 text-gray-400 text-xs py-6">
        <div class="max-w-7xl mx-auto px-4 text-center">
            &copy; 2011–<?php echo e(now()->year); ?> <span class="text-white">RoadToCitizenship.ca</span>. All Rights Reserved.
        </div>
    </footer>
...
<?php /**PATH /Users/mohamudhassanmayow/Desktop/citizenship-prep/resources/views/layouts/guest.blade.php ENDPATH**/ ?>