...
<?php $component->withAttributes([]); ?>
    ...
    <div class="flex min-h-screen bg-gray-50" x-data="{ sidebarOpen: window.innerWidth >= 1024, showResetModal: false }">
        ...
        <aside x-show="sidebarOpen"
            ...
            <a href="<?php echo e(route('courses.reading-resources', $navSection->id)); ?>"
        ...
        <main class="flex-1 p-6 lg:ml-0">
            <div class="max-w-2xl mx-auto">
                <div class="flex justify-between items-center mb-8">
                    ...
                    <a href="<?php echo e(route('courses.reading-resources', $section->id)); ?>"
                    class="inline-block px-8 py-4 bg-purple-600 text-white font-bold rounded-xl shadow-lg
                        ...
                        <?php echo e(__('Reading Resources for')); ?> <?php echo e($section->title); ?>
