    ...
    <div class="flex min-h-screen bg-gray-50" x-data="{ sidebarOpen: window.innerWidth >= 1024, showResetModal: false }">
        ...
        <div x-show="showResetModal" x-cloak
            ...
            <div @click.away="showResetModal = false"
                ...
                <p class="text-gray-700 mb-6"><?php echo e(__('This will permanently reset your progress for this driving region. You will start from question 1.')); ?></p>
                <div class="flex justify-center gap-4">
                    ...
                    <form action="<?php echo e(route('driving.reset-progress', $section->id)); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <button type="submit"
        ...
        <aside x-show="sidebarOpen"
            ...
            <div class="p-6 text-center border-b border-gray-700">
                <h3 class="text-2xl font-bold text-indigo-300"><?php echo e(__('Driving Regions')); ?></h3>
            </div>
            ...
            <nav class="flex-1 p-4 space-y-2">
                <?php $__currentLoopData = $allSections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $navSection): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <a href="<?php echo e(route('driving.show', $navSection->id)); ?>"
                       class="flex items-center px-4 py-2 rounded-lg transition-colors duration-200
                        ...
                        <img src="<?php echo e(asset($navSection->flag ?? 'images/default-driving-icon.png')); ?>" alt="<?php echo e($navSection->title); ?>" class="size-6 rounded-full mr-3 border border-gray-600">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            document.querySelectorAll('.quiz-form').forEach(form => {
                ...
                const incorrectIcon = feedbackIcon.classList.add('hidden'); // Corrected from incorrectIcon = feedbackIcon.querySelector('.incorrect-icon'); to ensure it's hidden initially
...
<?php endif; ?>
<?php /**PATH /Users/mohamudhassanmayow/Desktop/Study_Guide/resources/views/frontend/canadian-citizenship/driving-questions.blade.php ENDPATH**/ ?>