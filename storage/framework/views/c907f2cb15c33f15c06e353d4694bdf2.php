    ...
    <section class="bg-gray-50 py-16">
        <div class="max-w-7xl mx-auto px-4 text-center">
            <div class="bg-white rounded-xl shadow-lg p-8 transform transition-all duration-300 hover:shadow-2xl">
                <img src="<?php echo e(asset('images/canadian-flag.png')); ?>" alt="Canadian flag" class="mx-auto h-24 mb-6">
        ...
        <div class="max-w-6xl mx-auto px-4">
            <div class="grid md:grid-cols-2 gap-12 items-center">
                <div data-aos="fade-right">
                    <img src="<?php echo e(asset('images/reading.png')); ?>" alt="Person studying on a laptop" class="rounded-xl shadow-2xl">
                </div>
    ...
    <section id="sample-questions" class="py-12 sm:py-20">
        <div class="max-w-6xl mx-auto px-4">
            ...
            <div class="bg-white p-8 sm:p-12 rounded-3xl shadow-xl border border-gray-200 content-container">
                ...
                <p>
                    <a href="<?php echo e(route('free-quiz.show')); ?>" class="inline-block bg-indigo-600 hover:bg-indigo-700 text-white font-semibold py-3 px-6 rounded-full shadow-lg transition-colors text-lg mt-8">
                        Take a Free Test
                    </a>
                </p>
            </div>
...
<section id="payment" class="py-16 bg-gray-100">
    <div class="max-w-4xl mx-auto px-4 text-center">
        ...
        <div class="bg-white p-8 rounded-xl shadow-lg">
            ...
            <a href="<?php echo e(route('register.payment')); ?>" class="inline-block bg-green-600 hover:bg-green-700 text-white px-8 py-4 rounded-full font-semibold shadow-md transition-colors text-lg">
...
<?php echo $__env->make('layouts.guest', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mohamudhassanmayow/Desktop/Study_Guide/resources/views/frontend/canadian-citizenship/canadian-citizenship-prep.blade.php ENDPATH**/ ?>