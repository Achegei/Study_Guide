...
<section id="payment" class="py-12 bg-gray-100">
    <div class="max-w-6xl mx-auto px-4 text-center space-y-6">
        ...
        <!-- Subscribe Button -->
        <a href="<?php echo e(route('interac.purchase.submit')); ?>" class="inline-block bg-black hover:bg-red-600 text-white px-6 py-3 rounded-full font-semibold shadow transition">
            Subscribe Now
        </a>
    </div>
</section>
...
<div class="max-w-xl mx-auto mb-10">
    ...
    <div class="swiper-wrapper">
        <?php $__currentLoopData = $testimonials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $testimonial): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="swiper-slide bg-gray-50 p-6 rounded-xl shadow text-center">
                <img src="<?php echo e(asset($testimonial->avatar)); ?>" alt="<?php echo e($testimonial->name); ?>" class="mx-auto rounded-full w-20 h-20 mb-4 object-cover">
                <p class="italic text-gray-600 max-w-md mx-auto">"<?php echo e($testimonial->content); ?>"</p>
                <span class="mt-3 block font-semibold text-gray-800"><?php echo e($testimonial->name); ?></span>
            </div>
    ...
    <div class="flex justify-center gap-4 mt-6">
        ...
        <div class="text-center mt-8">
            <a href="<?php echo e(route('testimonials')); ?>" class="text-red-600 hover:underline font-semibold">Read More Testimonials →</a>
        </div>
    </div>
</section>
    ...
    <div class="max-w-7xl mx-auto px-4 text-center space-y-6">
        ...
        <div class="grid md:grid-cols-3 gap-6 text-left">
            <div class="bg-white p-6 rounded shadow">
                ...
                <a href="<?php echo e(route('blogs.index')); ?>" class="text-sm text-blue-600 mt-3 inline-block hover:underline">Learn More</a>
            </div>
            <div class="bg-white p-6 rounded shadow">
...
<section class="py-6 bg-green-50">
    <div class="max-w-3xl mx-auto px-4 flex flex-col md:flex-row items-center gap-6">
        <div class="md:w-1/2" data-aos="zoom-in">
            <img src="<?php echo e(asset('image/money-back.png')); ?>" alt="Money Back Guarantee" class="w-full max-w-xs mx-auto"> <!-- was max-w-sm -->
        </div>
...
<?php echo $__env->make('layouts.guest', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mohamudhassanmayow/Desktop/citizenship-prep/resources/views/welcome.blade.php ENDPATH**/ ?>