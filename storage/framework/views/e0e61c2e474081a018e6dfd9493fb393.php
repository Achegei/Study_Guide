    ...
    <section id="payment" class="py-12 bg-white">
        <div class="max-w-6xl mx-auto px-4 text-center space-y-6">
            ...
            <div class="bg-gray-100 p-8 rounded-xl shadow-lg">
                ...
                <!-- Subscribe Button -->
                <a href="<?php echo e(route('register.payment')); ?>" class="inline-block bg-black hover:bg-red-600 text-white px-8 py-3 rounded-full font-semibold shadow-md transition-colors text-lg">
                    Pay Now
                </a>
            </div>
        </div>
...
<?php echo $__env->make('layouts.guest', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mohamudhassanmayow/Desktop/citizenship-prep/resources/views/frontend/canadian-citizenship/canadian-citizenship-prep.blade.php ENDPATH**/ ?>