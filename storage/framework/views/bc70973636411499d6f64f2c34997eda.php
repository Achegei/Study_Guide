            ...
            <div class="space-y-8">
                <?php $__currentLoopData = $blogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $blog): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="bg-white p-6 rounded-2xl shadow-lg border border-gray-100 transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
                        ...
                        <a href="<?php echo e(route('citizenship-info.show', $blog->slug)); ?>" class="inline-flex items-center mt-4 text-blue-600 font-semibold hover:text-blue-800 transition-colors duration-200">
                            Read Full Article
...
<?php echo $__env->make('layouts.guest', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mohamudhassanmayow/Desktop/Study_Guide/resources/views/pages/citizenship-info.blade.php ENDPATH**/ ?>